...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow: QtWidgets.QMainWindow):
        ...
        MainWindow.setWindowTitle("HASH COMPRESS")
        ...
        self.pushButton.setAccessibleName("compress")
    ...
    def start_action(self):
        if (self.textBrowser.getPath is None):
            return
        self.compressThread = CompressThread(self.textBrowser.getPath(), method=self.comboBox.currentText()	)
        self.compressThread.processSignal.connect(self.changeProcess)
        self.compressThread.stateSignal.connect(self.changeButton)
